...
def main():
    ...
    action1_filename = log_file_path + "dogbot_action1_reward_history.csv"
    action2_filename = log_file_path + "dogbot_action2_reward_history.csv"
    action3_filename = log_file_path + "dogbot_action3_reward_history.csv"
